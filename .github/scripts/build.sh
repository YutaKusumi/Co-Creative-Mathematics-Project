...
<ul>
  ...
  <li><a href="06-Sixth-Work-Why-Military-AI-Cannot-Be-Aligned/Version-B-Policy-Edition/JA/Why-Military-AI-Cannot-Be-Aligned-Version-B-v4-JA.html">Version B v4 ― 改訂版（日本語・補遺II『証明されたゼロがないこと』を追加・<strong>v4.1強化済み</strong>〔回避の連鎖＝三つの独立な限界・艦隊相関の定量化・二つの追加反論〕・全巡の監査証跡同梱）</a></li>
