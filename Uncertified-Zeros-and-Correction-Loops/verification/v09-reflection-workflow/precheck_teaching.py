...
PAIRS = [('技①', 'たしかめる'), ('技②', '中身をきく'), ('技③', '二回以上きく'), ('技④', '逆もきく')]
for n, nm in PAIRS:
...
MUST_DOC = [('レジュメ', '測定の広さは項目ごとに異なる'), ('レジュメ', '類推の水準にとどまる'),
            ('レジュメ', '二回以上きく'), ('板書原稿', '二回以上きく'), ('スライド原稿', '二回以上きく'),
...
BAN = ['三つの技', '五つのやくそく', '五つの やくそく', 'AIはその方向をおぼえる', 'AIはその方向をおぼえていく',
       ...
       # v0.9.8: 標語を論理に合わせた（ε<3/n は n が増えるほど上界が下がる）
       '技③二回きく', '技③　二回きく', 'だいじなことは、二回きく', '大事なことは、二回きく',
       '大事なことは、もう一回きく', '大事なことは、もう一回 きく']
